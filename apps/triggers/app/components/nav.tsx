  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-4">
      ...
      >
        <a
          href="/"
          className="flex items-center gap-2 font-semibold text-sm tracking-tight rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
        >
          <svg
            className={`w-4 h-4 transition-colors ${scrolled ? 'text-accent' : 'text-fg'}`}
        ...
        <div className="flex items-center gap-5">
          ...
          <a
            href="https://github.com/triggers/"
            className={`text-sm rounded transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent ${
              scrolled ? 'text-bg/70 hover:text-bg' : 'text-muted hover:text-fg'
            }`}
          >
          ...
          <a
            href="/dashboard"
            className={`text-sm font-medium rounded-full px-4 py-1.5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent ${
              scrolled
