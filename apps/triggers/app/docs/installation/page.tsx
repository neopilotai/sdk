...
export const metadata: Metadata = {
  title: 'Installation',
  description: 'install triggers and understand the github permissions it needs.',
};
    ...
    <article className="py-12">
      ...
      <Section id="scope" title="Hosted Scope">
        <Note title="Current Deployment">
          ...
          <code className="text-accent">triggers</code> organizations. if you need
      ...
      <Section id="install" title="Install The GitHub App">
        <p className="text-base leading-7 text-white/62">
          Install triggers on the repositories where you want automatic issue and
          pr triage.
        </p>
        <a
      ...
      <Section id="permissions" title="Permissions">
        <Grid>
          ...
          <Card
            code="contents: read"
            description="read .github/triggers.yml from the repository."
          />
          <Card
            code="contents: write"
            description="open learning prs that update .github/triggers.yml when maintainers ask triggers to improve."
          />
        </Grid>
      </Section>
      ...
      <Section id="gateway" title="AI Gateway Auth">
        <p className="text-base leading-7 text-white/62">
          triggers can authenticate to ai gateway with either a static api key or
          a vercel oidc token.
        </p>
