  ...
  return (
    <article className="py-12">
      <Header
        section="Reference"
        title="Labels"
        description="Triggers works best when labels are descriptive, semantic, and clearly separated from workflow-only markers that belong in the blocklist."
      />
      ...
      >
        <p className="text-base leading-7 text-white/62">
          Triggers reads label descriptions from github every time it triages.
