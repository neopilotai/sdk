...
export const metadata: Metadata = {
  title: 'Introduction',
  description:
    'Triggers is an ai-powered github labeling agent with a blocklist, memory, and an operator console.',
};
  ...
  return (
    <article className="py-12">
      <Header
        section="Get Started"
        title="Introduction"
        description="Triggers labels issues and pull requests with ai, keeps blocklist enforcement out of the model, and gives maintainers an operator console to review every decision."
      />

      <Section id="overview" title="What Triggers Includes">
        <Note title="Hosted Scope">
          ...
          <code className="text-accent">triggers</code> organizations.
        </Note>
        <Grid>
          <Card
            title="Prompt"
            description="repo-specific classification guidance that tells triggers how to interpret your labels."
            code="soft guidance"
          />
          <Card
            title="Blocklist"
            description="hard enforcement for workflow labels that triggers must never apply automatically."
      ...
      <Section id="flow" title="How A Decision Flows">
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <Card
            title="1. Read"
            description="triggers reads the issue or pr, label descriptions, repo config, and matching memory."
          />
          <Card
            title="2. Classify"
      ...
      <Section id="benefits" title="Why The Design Is Split This Way">
        <Grid>
          ...
          <Card
            ...
            description="maintainers can speak naturally to @triggers instead of memorizing a rigid command grammar."
          />
          <Card
